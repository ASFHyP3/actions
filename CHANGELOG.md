...
- Added a warning to our [mypy documentation](https://github.com/ASFHyP3/actions/blob/update-ruff-and-mypy-options/README.md#reusable-mypyyml) regarding the limitations of using a static type checker on Python code.
