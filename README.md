...
This workflow:
* requires an `environment.yml` file at the root of the calling repository specifying all the runtime dependencies needed 
* will additionally output a Docker tag compatible version number. 
