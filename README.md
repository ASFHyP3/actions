...
Outputs the version number of the calling repository using one of three available methods:
* **`setup.py`**: The python package version number generated by running [`python setup.py --version`](https://setuptools.pypa.io/en/latest/deprecated/commands.html#running-setuptools-commands)
* **`setuptools_scm`**: The python package version number generated by running [`python -m setuptools_scm`](https://github.com/pypa/setuptools_scm#pyprojecttoml-usage)
* **`git`**: The git version number generated by running [`git describe --dirty --tags --long --match "*[0-9]*"`](https://git-scm.com/docs/git-describe) 

Note: the `setup.py` and `setuptools_scm` methods require an `environment.yml` file at the root of the calling repository
specifying all the runtime dependencies needed. 
...
jobs:
  call-version-info-workflow:
    ...
    with:
      ...
      method: 'setup.py'           # Optional; default shown
